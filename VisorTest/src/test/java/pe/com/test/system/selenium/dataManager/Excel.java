...
public class Excel {
	...
	public static String[][] leerExcel(String rutaArchivo, int sheet) {
		String[][] lista = null;
		int i = 0;
		String valor = "";
		try {
			...
			System.out.println(archivoExcel.getNumberOfSheets());
			XSSFSheet  hojaExcel = archivoExcel.getSheetAt(sheet);
