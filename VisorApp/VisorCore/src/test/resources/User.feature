...
Scenario: Registrar User
	...
	And hago click en el boton de Finalizar Registrar usuario
	Then el sistema me mostrara el mensaje Regisrar usuario de "Usted se registro exitosamente"
...
Scenario: Actualizar User 
	...
	And hago click en el boton de Guardar usuario cambios Registrar
	Then el sistema me mostrara el mensaje Registrar usuario de "Se actualizo correctamente los valores de registro"
